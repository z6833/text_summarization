...
from utils.config import (train_x_seg_path, train_y_seg_path,
                          valid_x_seg_path, valid_y_seg_path,
                          test_x_seg_path,
                          epochs, vocab_key_to_index_path,
                          transformer_pgn_checkpoint_dir, results_dir)

from src.build_seq2seq_transformer_pgn.train_eval_test import train, test, predict_result
...
def main():
    ...
    parser.add_argument("--valid_seg_x_dir", default=valid_x_seg_path, help="valid_seg_x_dir", type=str)
    parser.add_argument("--valid_seg_y_dir", default=valid_y_seg_path, help="valid_seg_y_dir", type=str)
    ...
    parser.add_argument("--checkpoint_dir", default=transformer_pgn_checkpoint_dir, help="checkpoint_dir", type=str)
    parser.add_argument("--transformer_model_dir", default=transformer_pgn_checkpoint_dir, help="Model folder")
